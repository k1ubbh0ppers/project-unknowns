...
During implementation, track deviations.
...
Data model, API contract, permission model, business rules.
User-facing flow, copy, states, empty/error cases.
Integration boundaries, migration/deploy impact, test strategy.
Mechanical refactors and low-risk file moves last.
Completion Memory
